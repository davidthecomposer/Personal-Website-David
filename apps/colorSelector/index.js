...
const activeSlider = window.getComputedStyle(document.querySelector('.sliders'), '::-webkit-slider-thumb');
...
const sliders = (event) => {
    ...
    let redHex = `#${hexToTwo(Number(value).toString(16))}${hexToTwo(Number(greenG).toString(16))}${hexToTwo(Number(blueB).toString(16))}`;
    let greenHex = `#${hexToTwo(Number(redR).toString(16))}${hexToTwo(Number(value).toString(16))}${hexToTwo(Number(blueB).toString(16))}`;
    let blueHex = `#${hexToTwo(Number(redR).toString(16))}${hexToTwo(Number(greenG).toString(16))}${hexToTwo(Number(value).toString(16))}`;
    ...
    if (name === 'red') {
        ...
        hslText.innerHTML = `hsl(${(hslResultRed[0] * 360).toFixed(0)}°, ${(hslResultRed[1] * 100).toFixed(0)}%, ${(hslResultRed[2] * 100).toFixed(0)}%)`;
        hsvText.innerHTML = `hsv(${(hsvResultRed[0] * 360).toFixed(0)}°, ${(hsvResultRed[1] * 100).toFixed(0)}%, ${(hsvResultRed[2] * 100).toFixed(0)}%)`;
        ...
        hslText.innerHTML = `hsl(${(hslResultGreen[0] * 360).toFixed(0)}°, ${(hslResultGreen[1] * 100).toFixed(0)}%, ${(hslResultGreen[2] * 100).toFixed(0)}%)`;
        hsvText.innerHTML = `hsv(${(hsvResultGreen[0] * 360).toFixed(0)}°, ${(hsvResultGreen[1] * 100).toFixed(0)}%, ${(hsvResultGreen[2] * 100).toFixed(0)}%)`;
        ...
        hslText.innerHTML = `hsl(${(hslResultBlue[0] * 360).toFixed(0)}°, ${(hslResultBlue[1] * 100).toFixed(0)}%, ${(hslResultBlue[2] * 100).toFixed(0)}%)`;
        hsvText.innerHTML = `hsv(${(hsvResultBlue[0] * 360).toFixed(0)}°, ${(hsvResultBlue[1] * 100).toFixed(0)}%, ${(hsvResultBlue[2] * 100).toFixed(0)}%)`;
        ...
        rgbText.innerHTML = `rgb(${rgbResultHue[0].toFixed(0)},${rgbResultHue[1].toFixed(0)},${rgbResultHue[2].toFixed(0)});`;
        red.value = rgbResultHue[0];
        green.value = rgbResultHue[1];
        blue.value = rgbResultHue[2];
        hsvText.innerHTML = `hsv(${(hsvResultHue[0] * 360).toFixed(0)}°, ${(hsvResultHue[1] * 100).toFixed(0)}%, ${(hsvResultHue[2] * 100).toFixed(0)}%);`;
        hsvSat.value = (hsvResultHue[1] * 100).toFixed(0);
        hsvValue.value = (hsvResultHue[2] * 100).toFixed(0);
        hexText.innerHTML = `#${hexToTwo(Number(red.value).toString(16))}${hexToTwo(Number(green.value).toString(16))}${hexToTwo(Number(blue.value).toString(16))}`;
        ...
        rgbText.innerHTML = `rgb(${rgbResultSat[0].toFixed(0)},${rgbResultSat[1].toFixed(0)},${rgbResultSat[2].toFixed(0)});`;
        red.value = rgbResultSat[0];
        green.value = rgbResultSat[1];
        blue.value = rgbResultSat[2];
        hsvText.innerHTML = `hsv(${(hsvResultSat[0] * 360).toFixed(0)}°, ${(hsvResultSat[1] * 100).toFixed(0)}%, ${(hsvResultSat[2] * 100).toFixed(0)}%);`;
        ...
        rgbText.innerHTML = `rgb(${rgbResultLight[0].toFixed(0)},${rgbResultLight[1].toFixed(0)},${rgbResultLight[2].toFixed(0)});`;
        red.value = rgbResultLight[0];
        green.value = rgbResultLight[1];
        blue.value = rgbResultLight[2];
        hsvText.innerHTML = `hsv(${(hsvResultLight[0] * 360).toFixed(0)}°, ${(hsvResultLight[1] * 100).toFixed(0)}%, ${(hsvResultLight[2] * 100).toFixed(0)}%);`;
        ...
        rgbText.innerHTML = `rgb(${rgbResultSatV[0].toFixed(0)},${rgbResultSatV[1].toFixed(0)}, ${rgbResultSatV[2].toFixed(0)})`;
        ...
        hexText.innerHTML = `#${hexToTwo(Number(red.value).toString(16))}${hexToTwo(Number(green.value).toString(16))}${hexToTwo(Number(blue.value).toString(16))}`;
        hslSat.value = (rgbToHsl(red.value, green.value, blue.value)[1] * 100).toFixed(0);
        hslLight.value = (rgbToHsl(red.value, green.value, blue.value)[2] * 100).toFixed(0);
        hslText.innerHTML = `hsl(${hueV}°,${hslSat.value}%,${hslLight.value}%)`;
    } else if (name === 'hsv-value') {
        hsvText.innerHTML = `hsv(${hueV}°,${hsvSatV}%,${value}%)`;
        rgbText.innerHTML = `rgb(${rgbResultValue[0].toFixed(0)},${rgbResultValue[1].toFixed(0)}, ${rgbResultValue[2].toFixed(0)})`;
...
const changeBGColor = () => {
    ...
    hexText.innerHTML = `#${hexToTwo(randR.toString(16))}${hexToTwo(randG.toString(16))}${hexToTwo(randB.toString(16))}`;
    hslText.innerHTML = `hsl(${(hslResult[0] * 360).toFixed(0)}°, ${(hslResult[1] * 100).toFixed(0)}%, ${(hslResult[2] * 100).toFixed(0)}%)`;
    hsvText.innerHTML = `hsv(${(hsvResult[0] * 360).toFixed(0)}°, ${(hsvResult[1] * 100).toFixed(0)}%, ${(hsvResult[2] * 100).toFixed(0)}%)`;
...
const saveColor = (event) => {
    if (event.target.style.backgroundColor === '') {
        ...
        let num = preview.style.backgroundColor.substring(4, preview.style.backgroundColor.length - 1).split(',');
        ...
        hslSat.value = (hslResult[1] * 100).toFixed(0);
        hslLight.value = (hslResult[2] * 100).toFixed(0);
        hexText.innerHTML = `#${hexToTwo(red.value.toString(16))}${hexToTwo(green.value.toString(16))}${hexToTwo(blue.value.toString(16))}`;
        hslText.innerHTML = `hsl(${(hslResult[0] * 360).toFixed(0)}°, ${(hslResult[1] * 100).toFixed(0)}%, ${(hslResult[2] * 100).toFixed(0)}%)`;
        hsvText.innerHTML = `hsv(${(hsvResult[0] * 360).toFixed(0)}°, ${(hsvResult[1] * 100).toFixed(0)}%, ${(hsvResult[2] * 100).toFixed(0)}%)`;
        fillGradient();
...
const addNewSwatch = (event) => {
    ...
    swatchContainer.insertBefore(newSwatch, swatchContainer.childNodes[swatchContainer.childNodes.length - 2]);
    swatchToRow();
};
...
const makeSwatchRow = (swatch) => {
    let num = swatch.style.backgroundColor.substring(4, swatch.style.backgroundColor.length - 1).split(',');
    red.value = Number(num[0]);
    green.value = Number(num[1]);
    blue.value = Number(num[2]);
    let hslResult = rgbToHsl(num[0], num[1], num[2]);
    ...
    newRow.innerHTML = `
   <tr class='new-row'> 
   <td class='color-column' style='background-color:${swatch.style.backgroundColor}'> </td>
   <td class='hex-column'> #${hexToTwo(Number(red.value).toString(16))}${hexToTwo(Number(green.value).toString(16))}${hexToTwo(Number(blue.value).toString(16))} </td>
   <td class='rgb-column'> ${swatch.style.backgroundColor}</td>
   <td class='hsl-column'> hsl(${(hslResult[0] * 360).toFixed(0)}°, ${(hslResult[1] * 100).toFixed(0)}%, ${(hslResult[2] * 100).toFixed(0)}%)</td>
   <td class='hsv-column'> hsv(${(hsvResult[0] * 360).toFixed(0)}°, ${(hsvResult[1] * 100).toFixed(0)}%, ${(hsvResult[2] * 100).toFixed(0)}%)</td>
   </tr>
   `;
