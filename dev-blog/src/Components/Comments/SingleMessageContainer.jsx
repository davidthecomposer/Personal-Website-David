...
import "../../Styles/Comments/SingleMessageContainer.scss";
...
const SingleMessageContainer = ({
	...
	const sendUpdatedVoteToServer = async () => {
		try {
			const response = await fetch(
				"https://cors-anywhere.herokuapp.com/https://blog-comments-api.herokuapp.com/vote",
				{
					method: "POST",
					headers: {
	...
	const sendReply = async (event) => {
		...
		try {
			const response = await fetch(
				"https://cors-anywhere.herokuapp.com/https://blog-comments-api.herokuapp.com/reply",
				{
					method: "POST",
					headers: {
						"Content-Type": "application/json",
